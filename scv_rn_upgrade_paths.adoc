...
---
= Upgrade-Pfade für das SnapCenter Plug-in für VMware vSphere
:allow-uri-read: 
...
[NOTE]
====
Ein Upgrade auf SnapCenter Plug-in für VMware vSphere (SCV) 4.8 und höher wird nur auf VMware vCenter Server 7 Update 1 und späteren Versionen unterstützt. Für VMware vCenter Server vor Version 7 Update 1 sollten Sie weiterhin SCV 4.7 verwenden.
