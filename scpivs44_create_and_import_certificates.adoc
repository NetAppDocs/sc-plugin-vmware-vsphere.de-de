...
---
= Erstellen und importieren Sie Zertifikate für den SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Weitere Informationen finden Sie unter  https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["KB-Artikel: Erstellen und/oder importieren Sie ein SSL-Zertifikat in SnapCenter Plug-in für VMware vSphere"].
