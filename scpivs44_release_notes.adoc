...
Weitere Informationen finden Sie unter https://library.netapp.com/ecm/ecm_download_file/ECMLP2886920["Versionshinweise zum SnapCenter Plug-in für VMware vSphere 5.0"^]
