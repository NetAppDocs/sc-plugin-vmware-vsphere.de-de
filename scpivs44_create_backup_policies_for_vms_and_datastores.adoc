...
+
** Cluster und Mediator wie im technischen Bericht beschrieben konfigurieren: https://www.netapp.com/pdf.html?item=/media/21888-tr-4878.pdf["TR-4878: SnapMirror Business Continuity"].
