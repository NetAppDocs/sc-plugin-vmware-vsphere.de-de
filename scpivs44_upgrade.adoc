...
---
= Upgrade von einer früheren Version des SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Ein Upgrade auf SCV 6.2 wird nur für VMware vCenter Server 7 Update 1 und spätere Versionen unterstützt, für VMware vCenter Server vor Version 7 Update 1 sollten Sie weiterhin SCV 4.7 verwenden. Das Upgrade ist bei nicht unterstützten Versionen von VMware vCenter Server unterbrechend.
...
CAUTION: Vor dem Upgrade ist zu überprüfen, ob Ihre Umgebung die Systemanforderungen erfüllt. Einzelheiten finden Sie unter link:scpivs44_deployment_planning_and_requirements.html["SnapCenter Plug-in für VMware vSphere Bereitstellungsplanung und Anforderungen"].
...
Die aktuellsten Informationen zu den unterstützten Versionen sind unter link:https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp Interoperabilitäts-Matrix-Tool (IMT)"^] zu finden.
...
+
.. Melden Sie sich bei der link:https://mysupport.netapp.com/products/index.html["NetApp Support-Website"^] an.
