...
---
= Datenschutz-Workflow für das SnapCenter Plug-in für VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Verbessern Sie den VMware-Schutz mit NetApp Backup and Recovery, das 3-2-1-Backup, Schutz vor Ransomware, automatisierte Backup-Verwaltung, verbesserte Skalierbarkeit, geringere Kosten und die zentrale Verwaltung mehrerer vCenter Instanzen bietet. Sie können SCV-Richtlinien, Snapshots und Zeitpläne zu NetApp Backup and Recovery migrieren und den gesamten VM-Schutz über eine einzige Konsole verwalten. Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/data-services-backup-recovery/["NetApp Backup and Recovery Dokumentation"].
...
In NetApp MetroCluster-Konfigurationen:
