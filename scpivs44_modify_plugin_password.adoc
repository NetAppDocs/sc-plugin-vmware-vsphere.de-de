...
keywords:  
summary: Wenn Sie das Administratorkennwort für die Verwaltungsbenutzeroberfläche des SnapCenter Plug-in for VMware vSphere nicht kennen, können Sie über die Wartungskonsole ein neues Kennwort festlegen. 
---
= Ändern Sie das SCV-Passwort über die Wartungskonsole
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
