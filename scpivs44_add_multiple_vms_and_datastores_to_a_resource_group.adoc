...
[role="lead"]
Mithilfe des Assistenten zum Bearbeiten von Ressourcengruppen von SnapCenter VMware vSphere können Sie einer vorhandenen Ressourcengruppe mehrere Ressourcen hinzufügen.
...
.Schritte
. Klicken Sie im linken Navigator-Bereich des SCV-Plug-ins auf *Ressourcengruppen*, wählen Sie dann eine Ressourcengruppe aus und klicken Sie dann auf image:scpivs44_image39.png["Fehler: Fehlendes Grafikbild"] *Ressourcengruppe bearbeiten* um den Assistenten zu starten.
